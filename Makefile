...
CMAKE_OTPS_cufft-trad             = -DFFT=cuFFT  $(if $(CUDA_ARCH_LIST),-DCUDA_ARCH_LIST='$(CUDA_ARCH_LIST)') -DUSE_CUDA_MEMCPY=ON -DPROFILE_GAUSSIAN=ON -DUSE_KERNEL_SCHED=ON 
CMAKE_OTPS_cufft-openmp-trad      = -DFFT=cuFFT  $(if $(CUDA_ARCH_LIST),-DCUDA_ARCH_LIST='$(CUDA_ARCH_LIST)') -DOPENMP=ON -DUSE_CUDA_MEMCPY=ON -DPROFILE_GAUSSIAN=ON -DUSE_KERNEL_SCHED=ON
